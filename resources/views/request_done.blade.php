        ...
        <div class="row">
            <nav aria-label="breadcrumb" class="f-width">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">نجاح طلب المشروع</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="row" style="margin-top: 30px;">
          <div class="col-lg-12 col-sm-12">
            <div class="card other_details">
              <div class="card-body">
                 <p>تم ارسال طابك بنجاح وتم تسجيله فى لوحة التحكم الخاص بك واذا كنت غير مسجل فلقد تم ارسال معلومات الدخول الى بريدك الالكترونى ولا تتردد فى التواصل معنا </p>
              </div>
            </div>
