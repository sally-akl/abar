...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">@lang('site.projects_all') - @lang('site.new_add') </h3>
  </div>
  <div class="card-body py-3">
    ...
    <form method="POST" action="{{ url('dashboard/projects') }}" enctype="multipart/form-data" class="form_submit_model">
      @csrf
    <div class="row">
      <div class="col-lg-6">
        <div class="mb-3">
          <label class="form-label">@lang('site.proj_name')</label>
          <input type="text" class="form-control" name="proj_name" value="{{old('proj_name')}}">
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
      ...
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="proj_status">
            ...
            <option value="@lang('site.active')" {{old('proj_status') == "مفعل"?"selected":""}}>@lang('site.active')</option>
            <option value="@lang('site.not_active')" {{old('proj_status') == "غير مفعل"?"selected":""}}>@lang('site.not_active')</option>
          </select>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="proj_av_for_request" >
            <option value="">@lang('site.select')</option>
            <option value="1" {{old('proj_av_for_request') == 1?"selected":""}}>@lang('site.yes')</option>
            <option value="0" {{old('proj_av_for_request') == 0?"selected":""}}>@lang('site.no')</option>
          </select>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <input type="number" class="form-control" name="from" value="{{old('from')}}">
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
          <label class="form-label">@lang('site.to')</label>
          <input type="number" class="form-control" name="to" value="{{old('to')}}">
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="period_type" >
            <option value="">@lang('site.select')</option>
            <option value="@lang('site.months')" {{old('period_type') == "اشهر"?"selected":""}}>@lang('site.months')</option>
            <option value="@lang('site.days')" {{old('period_type') == "ايام"?"selected":""}}>@lang('site.days')</option>
          </select>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="proj_exist_in_store" >
            <option value="">@lang('site.select')</option>
            <option value="1" {{old('proj_exist_in_store') == 1?"selected":""}}>@lang('site.yes')</option>
            <option value="0" {{old('proj_exist_in_store') == 0?"selected":""}}>@lang('site.no')</option>
          </select>
        </div>
      </div>
    </div>
          ...
          <select class="form-control" name="proj_country" >
            <option value="">@lang('site.select')</option>
              @foreach(\App\Country::all() as $country)
                <option value="{{$country->id}}" {{old('proj_country') == $country->id?"selected":""}}>{{$country->title}}</option>
              @endforeach
          </select>
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="project_category" >
            <option value="">@lang('site.select')</option>
            <option value="@lang('site.abar')" {{old('project_category') == 'ابار'?"selected":""}}>@lang('site.abar')</option>
            <option value="@lang('site.masged')" {{old('project_category') == 'مساجد'?"selected":""}}>@lang('site.masged')</option>
            <option value="@lang('site.schools')" {{old('project_category') == 'مراكز ومدارس'?"selected":""}}>@lang('site.schools')</option>
          </select>
        </div>
      </div>
    </div>
      ...
      <div class="col-lg-12">
        <div class="mb-3">
          <label class="form-label">@lang('site.pro_details')</label>
            <textarea class="form-control user_body" rows="3" name="pro_details"></textarea>
        </div>
      </div>
    </div>
    <div class="row abar" style="display:none;">
      <div class="col-lg-6 deep">
        <div class="mb-3">
          ...
          <input type="text" class="form-control" name="proj_deep" value="{{old('proj_deep')}}">
        </div>
      </div>
      <div class="col-lg-6">
        <div class="mb-3">
          <label class="form-label">@lang('site.price')</label>
          <input type="number" class="form-control" name="proj_price" value="{{old('proj_price')}}">
        </div>
      </div>
    </div>
    <div class="row abar" style="display:none;">
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <div class="characters_div">
            <div class="row ch_htm_div remove_ch_div1">
               <div class="col-lg-9">
                  <input type="text" class="form-control" name="characters1" >
               </div>
            ...
            <div class="row  ch_htm_div msgd_remove_ch_div1">
               <div class="col-lg-2">
                 <label>وصف المسجد</label>
                  <input type="text" class="form-control" name="msgd_characters1" >
               </div>
               <div class="col-lg-2">
                 <label>عدد المصلين</label>
                  <input type="number" class="form-control" name="msgd_prayer_num1" >
               </div>
               <div class="col-lg-2">
                  <label>نوع السقف</label>
                  <input type="text" class="form-control" name="ceil_num1" >
               </div>
               <div class="col-lg-2">
                 <label>المساحة</label>
                  <input type="number" class="form-control" name="area_num1" >
               </div>
               <div class="col-lg-2">
                 <label>السعر</label>
                  <input type="number" class="form-control" name="price_num1" >
               </div>
