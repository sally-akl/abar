...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">اضافة مقال للمدونة</h3>
  </div>
  <div class="card-body py-3">
    ...
    <form method="POST" action="{{ url('dashboard/blog') }}" enctype="multipart/form-data" class="form_submit_model">
      @csrf
    <div class="row">
      <div class="col-lg-6">
        <div class="mb-3">
      ...
      <div class="col-lg-6">
        <div class="mb-3">
          ...
          <select class="form-control" name="category_name">
            ...
            <option value="المساجد" {{old('category_name') == "المساجد"?"selected":""}}>المساجد</option>
            <option value="الابار" {{old('category_name') == "الابار"?"selected":""}}>الابار</option>
            <option value="المراكز والمدارس" {{old('category_name') == "المراكز والمدارس"?"selected":""}}>المراكز والمدارس</option>
          </select>
        </div>
      </div>
      <div class="col-lg-6">
      ...
      <div class="col-lg-12">
        <div class="mb-3">
          <label class="form-label">محتوى المقال</label>
            <textarea class="form-control user_body" rows="3" name="blog_desc"></textarea>
        </div>
      </div>
    </div>
