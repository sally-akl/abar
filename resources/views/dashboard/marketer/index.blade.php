...
<div class="card">
  <div class="card-header">
    <h3 class="card-title">@lang('site.marketer')</h3>
  </div>
...
<div class="modal modal-blur fade" id="add_edit_modal" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <form method="POST" action="{{ url('dashboard/marketer') }}" class="form_submit_model">
...
<script type="text/javascript">
  var _sucess = function(response)
  {
    if(response.sucess)
    {
      ...
      window.location.href = '{{url("/dashboard/marketer")}}';
    }
    else
    {
      var $error_text = "";
  ...
  $(".edit_btn").on("click",function()
  {
      ...
      var url_edit = '{{url("/dashboard/marketer")}}'+"/"+id;
      $(".form_submit_model").attr("action",url_edit);
      $.ajax({
          url: '{{url("/dashboard/marketer")}}'+"/"+id+"/edit",
          type: 'GET',
          dataType: 'json',
  ...
  $(".add_btn").on("click",function(){
      $("input[name='method_type']").val("add");
      $(".form_submit_model").attr("action",'{{url("/dashboard/marketer")}}');
  ...
  $(".delete_it_sure").on("click",function(){
    ...
    var url_delete = '{{url("/dashboard/marketer")}}'+"/"+id;
