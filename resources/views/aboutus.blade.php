...
<section class="blogs-block  w-curve replace-mr no-bg">
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <h3 class="main-title">عن المؤسسة</h3>

            </div>
        </div>
        <div class="row about_us">
          <div class="col-md-12 col-lg-12">
            <h4><i class="fa fa-align-justify" aria-hidden="true"></i> أهداف المؤسسة</h4>

            <p>
               1- العمل على تزويد البلدان الفقيرة حول العالم بركائز الحياة الانسانية وعلى رأسها الماء العذب
            </p>
            <p>
              2- 	تسهيل تنفيذ مشاريع حفر الابار وبناء المساجد بالنيابة عن عملائنا وفقا للمواصفات والمعايير المعتمدة
            </p>
            <p>
              3- 	توسيع نطاق خدماتنا ليشمل المزيد من دول العالم
            </p>


           <h4><i class="fa fa-thumbs-up" aria-hidden="true"></i> قيم المؤسسة</h4>
            <p>1- الاتقان في العمل </p>
            <p>2- التطوير المستمر </p>
            <p>3- الأمانة </p>
            <p>4- المصداقية والوضوح </p>


            <h4><i class="fa fa-file" aria-hidden="true"></i> تراخيص المؤسسة الرسمية</h4>
            <p>آبار السقاية مؤسسة رسمية ومرخصة من وزارة التجارة لمزاولة نشاط حفر الآبار وبناء المساجد داخل المملكة وخارجها
رقم السجل التجاري 4030327198
</p>


           <h4><i class="fa fa-star" aria-hidden="true"></i> انجازات المؤسسة </h4>
           <p>تم بحمد الله تنفيذ ما يزيد عن 750 مشروع في 8 دول في آسيا وأفريقيا مما مكننا من ايصال مشاريعنا إلى أكثر من50 ألف مستفيد وحزنا على ثقة أكثر من 600 عميل ولازالت المسيرة مستمرة نحو مزيد من الانتشار بتسهيل تنفيذ مشاريع الآبار والمساجد لعملائنا وإيصالها لأكبر عدد من المستفيدين </p>
          </div>
        </div>
    </div>
</section>
