...
@endforeach
 ...
 <a href="{{url('/')}}/store/category/show/ابار" class="btn btn btn-main auto-width mt-30 center-horizontal mor_btn_projects">المزيد من مشاريع الابار</a>
        ...
        <a href="{{url('/')}}/store/category/show/مساجد" class="btn btn btn-main auto-width mt-30 center-horizontal mor_btn_projects">المزيد من مشاريع المساجد</a>
          ...
          <a href="{{url('/')}}/store/category/show/المراكز والمدارس" class="btn btn btn-main auto-width mt-30 center-horizontal mor_btn_projects">المزيد من مشاريع المراكز والمدارس</a>
